#!/usr/bin/env bash
# TimeLens-7B: run GRPO then eval on TimeLens-Bench. No SFT; model_path = base Qwen2.5-VL-7B.
...
job_name=""
train_output_root="output/TimeLens-7B/rlvr"
eval_pred_root="output/TimeLens-7B/eval-rlvr"
