...
output_root="output/TimeLens-2B/sft-lact"
report_to="none"
...
run_name="sft-lact-${run_tag}_MAXFRAMES-${fps_max_frames}_FPS-${fps}_TOTALtokens-${total_tokens}_MINtokens-${min_tokens}"
