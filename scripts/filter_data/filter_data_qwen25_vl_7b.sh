#!/usr/bin/env bash
# TimeLens-7B filter: same hyperparams as TimeLens-7B eval (Qwen2.5-VL, interleave timestamp).
# Usage: set model_path to Qwen2.5-VL-7B-Instruct or TimeLens-7B (recommended for same processor config).
...
fps=2
fps_max_frames=448
pred_root="output/TimeLens-7B/filter-data"
seed=42
